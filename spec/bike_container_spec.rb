...
# Testing specification for a Bike Container
...
describe BikeContainer do
  ...
  it 'should raise error when an invalid bike is released' do
    expect { holder.release(bike) }.to raise_error("#{bike} does not exist!")
  end

  it 'should raise error when an invalid object is released' do
    not_a_bike = 1
    expect { holder.release(not_a_bike) }
      .to raise_error("#{not_a_bike} is not a bike!")
  end
end
